...
$hquery = 'SELECT * FROM registerlist';
    ...
    <nav class="navbar navbar-expand-lg fixed-top mt-0 ">
        <div class="container-fluid bg-dark ">
            ...
            <a class=" d-flex align-items-center navbar-brand text-decoration-none text-light brand medium-text me-5" href="#">
               ...
               <font class=" fs-1" color='#B23F47'> Vinno Vista</font><?php  ?>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                if($_SESSION['login']){
                 ...
                 <font color='#32ff6f'>".$_SESSION['login']."</font>

                 </a>
               
                 <ul class='dropdown-menu bg-dark text-light '>
                   <li><a class='dropdown-item text-light  brand' href='#'>Action</a></li>
                   <li><a class='dropdown-item text-light  brand' href='#'>Another action</a></li>
                   <li><a class='dropdown-item text-light brand' href='#'>Something else here</a></li>
                 </ul>
               </div>
                 ";
                   
                }else{
                 echo    "<a class='  fs-4 text-light text-decoration-none  me-md-5  way ' data-bs-toggle='modal' data-bs-target='#staticBackdrop'  type='submit'><font color='#32ff6f'>Login</font></a>";
  ...
  <div class="modal-dialog ">
    <div class="modal-content bg-dark text-light">
      <div class="modal-header">
        <h1 class="modal-title fs-4 text-center" id="staticBackdropLabel">Log in to Your Account</h1>
